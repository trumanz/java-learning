...
public class CriteriaTest  {
	...
	public void  paginationTest(){
		...
		Assert.assertEquals("b", ((Employee)results.get(1)).getFirstName());
		
		cr.setFirstResult(2);
		results = cr.list();

		Assert.assertEquals(2, results.size());
		Assert.assertEquals("c", ((Employee)results.get(0)).getFirstName());
		Assert.assertEquals("d", ((Employee)results.get(1)).getFirstName());
	...
	public void sortTest(){
		...
		Assert.assertEquals("a", ((Employee)results.get(1)).getFirstName());
	}
